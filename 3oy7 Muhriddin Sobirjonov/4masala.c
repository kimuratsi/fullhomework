...
struct  AEROPORT uchish[10] = {
    ...
    /*3*/   {"Boeing A12 ", 30, 1, 2024, "Urganch", "Astana", 5, 0},
    ...
    /*9*/   {"Boeing A101", 16, 6, 2024, "Samarqand", "Astana", 3, 35},
    /*10*/  {"Airbus A100", 18, 2, 2024, "Nukus", "Toshkent", 3, 55}
    };

    for(int i = 0; i < 10; i++){
        if(uchish[i].oy == 6 || uchish[i].oy == 7 || uchish[i].oy == 8){
            ...
            printf("uchish soati:  %d:%d", uchish[i].soat, uchish[i].min);
            puts("\n");
        }
    }
